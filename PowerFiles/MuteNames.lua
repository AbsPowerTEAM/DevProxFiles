...
if DevAbs:get(Power.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Power.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Power.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Power.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Power.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Power.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
PowerName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if PowerName then 
PowerNames = DevAbs:smembers(Power.."Abs:Mute:Names"..msg.chat_id_) or ""
if PowerNames and PowerNames[1] then 
for i=1,#PowerNames do 
if PowerName:match("(.*)("..PowerNames[i]..")(.*)") then 
...
DevAbs:set(Power.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Power.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
